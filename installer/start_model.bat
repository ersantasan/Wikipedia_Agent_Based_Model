@ECHO OFF
TITLE Collaborative_Content_Creation
...
CD Collaborative_Content_Creation

REM Start the Model
START javaw -Xss10M -Xmx400M -cp %CP% repast.simphony.runtime.RepastMain ./Collaborative_Content_Creation.rs
